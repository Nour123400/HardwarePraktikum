...
int main(){
	...
	for (uint16_t x =208; x <=1023; x+=1)
	{
     ...
     //   stromG= 0;
       ...
       // std::cout<<"RD    "<<Vlot_Rd<<"V"<<std::endl;
      //  std::cout<<"D     "<<Volt_D<<"V"<<std::endl;
        std::cout<<"ID    "<<stromD<<"mA"<<std::endl<<std::endl;
        
        
        // std::cout<<"RG    "<<Volt_Rg<<"V"<<std::endl;
    //    std::cout<<"G     "<<Volt_G<<"V"<<std::endl;
    //    std::cout<<"IG    "<<Volt_Rg<<"mA"<<std::endl<<std::endl;
     

        
     //  drv.delay_ms();
       pf.addDot(Dot(x,stromD*204,curve0));
	 //  pf.addDot(Dot(x,stromG*200,curve1));
